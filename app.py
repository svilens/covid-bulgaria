...
fig_gen_stats_weekly.add_trace(go.Scatter(x=covid_general_weekly.index[1:], y=covid_general_weekly.new_recoveries[1:], name='New recoveriers'), secondary_y=False)
...
fig_gen_stats_weekly.update_yaxes(title_text="Confirmed/recovered", secondary_y=False)
fig_gen_stats_weekly.update_yaxes(title_text="Deaths", secondary_y=True)
